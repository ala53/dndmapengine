    ...
    class TouchScreenFixup {
        ...
        _onTouchStart(e) {
            ...
            for (var i = 0; i < touches.length; i++) {
                ...
                if (point) {
                    ...
                    this.touchMove({ changedTouches: [point] });
                }
                else {
                    //New tracking point
                    ...
                    this.touchStart({ changedTouches: [point] });
                }
            }
        }
        ...
        _onTouchEnd(e) {
            ...
            for (var i = 0; i < touches.length; i++) {
                ...
                if (Date.now() - point._lastMove > TouchScreenFixup._touchTimeout) {
                    ...
                    this.touchEnd({ changedTouches: [point] });
                }
            }
        }
        ...
        _matchNearest(x, y) {
            ...
            for (var i = 0; i < this._activeTouchPoints.length; i++) {
                ...
                if (dist < TouchScreenFixup._timeoutResumeMaxDistPx && dist < closest && pt._hasTimedOut) {
                    closest = dist;
                    closestPt = pt;
                }
            }
